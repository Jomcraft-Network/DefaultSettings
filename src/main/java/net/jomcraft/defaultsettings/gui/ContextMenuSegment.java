...
public class ContextMenuSegment extends Segment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		NEX.drawRectRoundedCorners(this.posX, this.posY, this.posX + this.width, this.posY + this.height, color, 2);
		int selected = isSelectedSome(mouseX, mouseY);
		if(selected > -1) {
			color = 0xff545454;
        	...
        	if(selected == 0)
        		...
        		NEX.drawRectRoundedCorners(this.posX + 0.5F, this.posY + 2, this.posX + this.width - 0.5F, this.posY + 15, color, 2);
        	
        	else if(selected == 1)
        		NEX.drawRectRoundedCorners(this.posX + 0.5F, this.posY + 17, this.posX + this.width - 0.5F, this.posY + 30, color, 2);
        	
        	else if(selected == 2)
        		NEX.drawRectRoundedCorners(this.posX + 0.5F, this.posY + 32, this.posX + this.width - 0.5F, this.posY + 45, color, 2);
        	
        	else if(selected == 3)
        		NEX.drawRectRoundedCorners(this.posX + 0.5F, this.posY + 47, this.posX + this.width - 0.5F, this.posY + 60, color, 2);
    	...
    	NEX.drawRect(this.posX + 1.5F, this.posY + 15.75F, this.posX + this.width - 1.5F, this.posY + 16.25F, color, false, null, false);
    	
    	NEX.drawRect(this.posX + 1.5F, this.posY + 30.75F, this.posX + this.width - 1.5F, this.posY + 31.25F, color, false, null, false);
		
    	NEX.drawRect(this.posX + 1.5F, this.posY + 45.75F, this.posX + this.width - 1.5F, this.posY + 46.25F, color, false, null, false);
		...
		fontRenderer.drawString("Delete", this.getPosX() + 3, this.getPosY() + 5, NEX.calcAlpha(0xffffffff, 1 - alpha).getRGB(), 0.9F, true);
		
		fontRenderer.drawString("Rename", this.getPosX() + 3, this.getPosY() + 20, NEX.calcAlpha(0xffffffff, 1 - alpha).getRGB(), 0.9F, true);
		
		fontRenderer.drawString("Clone", this.getPosX() + 3, this.getPosY() + 35, NEX.calcAlpha(0xffffffff, 1 - alpha).getRGB(), 0.9F, true);
		
		fontRenderer.drawString("Set Main", this.getPosX() + 3, this.getPosY() + 50, NEX.calcAlpha(0xffffffff, 1 - alpha).getRGB(), 0.9F, true);
		glDisable(GL_BLEND);
