...
public class CommandDefaultSettings {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        LiteralArgumentBuilder<CommandSourceStack> literalargumentbuilder = LiteralArgumentBuilder.<CommandSourceStack>literal("defaultsettings");
        ...
        /*event.getServer().getCommands().getDispatcher()*/dispatcher.register(Commands.literal("ds").redirect(node));
    }
