...
import net.jomcraft.defaultsettings.gui.MenuScreen.MutableByte;
...
public class ButtonBulkActionSegment extends Segment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.parent.cache_activity == 1) {
			...
			NEX.drawLine2D_2(f, f1, f2, f3, scaleFactor, 4, new Vec2f((float) this.getPosX(), (float) this.getPosY() + 3.5F), new Vec2f((float) this.getPosX() + 5.5F, (float) this.getPosY() + 3.5F));
		}
		...
		if (this.parent.cache_activity == 2) {
			...
			NEX.drawLine2D_2(f, f1, f2, f3, scaleFactor, 4, new Vec2f((float) this.getPosX() - 1, (float) this.getPosY() + 3.5F), new Vec2f((float) this.getPosX() + 4 - 1, (float) this.getPosY() + 4 + 3.5F), new Vec2f((float) this.getPosX() + 7, (float) this.getPosY() - 5 + 3.5F));
		}
