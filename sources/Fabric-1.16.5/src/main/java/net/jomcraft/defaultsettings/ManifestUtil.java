...
public final class ManifestUtil {
    ...
    public static Manifest readManifest(Class<?> cls) throws IOException, URISyntaxException, UrlConversionException {
    ...
    public static Manifest readManifest(URL codeSourceUrl) throws IOException, URISyntaxException, UrlConversionException {
    ...
    public static List<URL> getClassPath(Manifest manifest, Path baseDir) throws MalformedURLException, UrlConversionException {
