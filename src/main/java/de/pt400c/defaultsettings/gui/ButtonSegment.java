...
public class ButtonSegment extends Segment {
	...
	public void render(float mouseX, float mouseY, float partialTicks) {
		...
		MC.fontRenderer.drawString(this.title, (float)((posX + this.getWidth() / 2) - MC.fontRenderer.getStringWidth(this.title) / 2), (float) (posY + this.getHeight() / 2 - 4), calcAlpha(0xff3a3a3a, alpha).getRGB(), false);
