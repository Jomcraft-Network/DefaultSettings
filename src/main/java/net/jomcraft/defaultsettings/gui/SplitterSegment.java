...
public class SplitterSegment extends BakedSegment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if(!compiled) {
			...
			NEX.drawGradientCircle(0, 2.2F, 2F, 270, 75, 0xffaaaaaa, 0x00e6e6e6);
			NEX.drawGradientCircle(0, this.getHeight() - 2.2F, 2F, 0, 75, 0xffaaaaaa, 0x00e6e6e6);
			NEX.drawGradient(0, 2.2F, 2F, this.getHeight() - 2.2F, 0xffaaaaaa, 0x00e6e6e6, 0);
			...
			NEX.drawRect(0, 1, 1, this.getHeight() - 1, 0xffe6e6e6, true, null, false);
