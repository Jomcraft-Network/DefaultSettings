...
public class DefaultSettings implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(BuiltInRegistries.COMMAND_ARGUMENT_TYPE, Identifier.fromNamespaceAndPath(MODID, "config"), config);
        Registry.register(BuiltInRegistries.COMMAND_ARGUMENT_TYPE, Identifier.fromNamespaceAndPath(MODID, "operation"), operation);
        Registry.register(BuiltInRegistries.COMMAND_ARGUMENT_TYPE, Identifier.fromNamespaceAndPath(MODID, "type"), type);
