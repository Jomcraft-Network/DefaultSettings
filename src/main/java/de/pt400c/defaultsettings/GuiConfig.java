...
public class GuiConfig extends DefaultSettingsGUI {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.fontRendererObj.drawStringWithShadow("Tab", MathHelper.clamp(72 / 2 - (this.fontRendererObj.getStringWidth("Tab") / 2), 0, Integer.MAX_VALUE), 10, 16777215);
        
        int posX = MathHelper.clamp((this.width - 74) / 2 + 74 - (this.fontRendererObj.getStringWidth("- DefaultSettings -") / 2), 74, Integer.MAX_VALUE);
