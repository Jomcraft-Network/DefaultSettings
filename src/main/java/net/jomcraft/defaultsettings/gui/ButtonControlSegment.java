...
public class ButtonControlSegment extends BakedSegment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if(!compiled) {
			...
			glScissor(4 * scaledresolution.getScaleFactor(), (int) (5 * scaledresolution.getScaleFactor()), (int) ((this.getWidth() - 8) * scaledresolution.getScaleFactor()), (int) (20 * scaledresolution.getScaleFactor()));
