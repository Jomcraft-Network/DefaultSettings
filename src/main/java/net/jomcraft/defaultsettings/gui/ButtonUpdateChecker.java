...
public class ButtonUpdateChecker extends ButtonSegment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		glScissor((6 + (int) (this.menu.offs / 2.8F)) * scaledresolution.getScaleFactor(), (int) (5) * scaledresolution.getScaleFactor(), (int)((54 - this.menu.offs / 0.6F) * scaledresolution.getScaleFactor()), 25 * scaledresolution.getScaleFactor());
