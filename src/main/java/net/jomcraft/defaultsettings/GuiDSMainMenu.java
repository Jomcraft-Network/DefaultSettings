...
public class GuiDSMainMenu extends DefaultSettingsGUI {
    ...
    public void func_231160_c_() {
        ...
        this.addSegment(new TextSegment(this, this.field_230708_k_ / 2 - fontRenderer.getStringWidth("- DefaultSettings -", 1, true) / 2, 7, 0, 0, "- DefaultSettings -", 0xfffafafa, false, 1.2F));
		...
		if(textWidth > this.field_230708_k_ - 5) 
			lines.addAll(fontRenderer.listFormattedStringToWidth(text, this.field_230708_k_ - 5, true));
		else 
			lines.add(text);
