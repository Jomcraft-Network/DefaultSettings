...
public class PopupWindow extends Segment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		posX = 5;
		posY = 5;
		NEX.drawRectRoundedUpper((float) this.posX, (float) this.posY, (float) (this.posX + width), (float) (this.posY + 24), 0xff505050);
		NEX.drawRectRoundedLower((float) this.posX, (float) this.posY + 24, (float) (this.posX + width), (float) (this.posY + height), 0xff2c2c2c);
		NEX.drawRect((float) this.posX, (float) this.posY + 24, (float) (this.posX + width), this.posY + 25, 0xff3b3b3b, true, null, false);
	}
	...
	public boolean isSelected(int mouseX, int mouseY) {
		return (mouseX >= this.getPosX() && mouseY >= this.getPosY() + 10 && mouseX < this.getPosX() + this.getWidth() && mouseY < this.getPosY() + 24) || (mouseX >= this.getPosX() + 10 && mouseY >= this.getPosY() && mouseX < this.getPosX() + this.getWidth() - 10 && mouseY < this.getPosY() + 10) || (NEX.distanceBetweenPoints((float) this.getPosX() + 10F, (float) this.getPosY() + 10F, (float) mouseX, (float) mouseY) <= 10) || (NEX.distanceBetweenPoints((float) this.getPosX() + this.getWidth() - 10F, (float) this.getPosY() + 10F, (float) mouseX, (float) mouseY) <= 10);
	}
