...
import net.jomcraft.defaultsettings.gui.AboutSegment;
import net.jomcraft.defaultsettings.gui.BakedSegment;
import net.jomcraft.defaultsettings.gui.ButtonControlSegment;
import net.jomcraft.defaultsettings.gui.ButtonMenuSegment;
import net.jomcraft.defaultsettings.gui.ButtonRoundSegment;
import net.jomcraft.defaultsettings.gui.ButtonUpdateChecker;
import net.jomcraft.defaultsettings.gui.DefaultSettingsGUI;
import net.jomcraft.defaultsettings.gui.ExportSegment;
import net.jomcraft.defaultsettings.gui.HelpSegment;
import net.jomcraft.defaultsettings.gui.LeftMenu;
import net.jomcraft.defaultsettings.gui.MenuArea;
import net.jomcraft.defaultsettings.gui.MenuScreen;
import net.jomcraft.defaultsettings.gui.PopupSegment;
import net.jomcraft.defaultsettings.gui.PopupWindow;
import net.jomcraft.defaultsettings.gui.ProfilesSegment;
import net.jomcraft.defaultsettings.gui.QuitButtonSegment;
import net.jomcraft.defaultsettings.gui.ScrollableSegment;
import net.jomcraft.defaultsettings.gui.Segment;
import net.jomcraft.defaultsettings.gui.SplitterSegment;
