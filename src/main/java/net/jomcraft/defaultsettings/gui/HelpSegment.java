...
import net.jomcraft.defaultsettings.GuiConfig.HeaderPart;
...
public class HelpSegment extends BakedSegment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if(!compiled) {
	    	...
	    	NEX.drawRectRoundedCorners(0, 0, this.width, this.height, NEX.calcAlpha(0xff696969, this.processFactor).getRGB(), 4);
			...
			NEX.drawScaledTex(2, this.height / 2 - 16 / 2, (int) 16, (int) 16);
			glDisable(GL_BLEND);
