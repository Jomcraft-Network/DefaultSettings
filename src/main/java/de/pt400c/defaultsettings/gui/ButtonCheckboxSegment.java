...
public class ButtonCheckboxSegment extends Segment {
	...
	public ButtonCheckboxSegment(Screen gui, float posX, float posY, float width, float height, String name, boolean popupSegment, ScrollableSegment parent, boolean active) {
