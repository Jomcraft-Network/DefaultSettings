...
public class AboutSegment extends Segment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		for(String line : lines) {
     	...
     	fontRenderer.drawString(Loader.instance().getMCVersionString().split(" ")[1] + "-" + DefaultSettings.VERSION, (float) this.getPosX() + 125, (float) this.getPosY() + 90, 0xff9e9e9e, 1.2F, false);
