...
public class ButtonMenuSegment extends ButtonSegment {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		if(!(width < 3.5F)) {
			...
			glScissor((int) ((this.getPosX() + 2 + this.offsetX) * scaleFactor), (int) ((MC.func_228018_at_().getScaledWidth() - this.getPosY() - this.getHeight()) * scaleFactor), (int) ((this.getWidth() - 4) * scaleFactor), (int) (this.getHeight() * scaleFactor));
