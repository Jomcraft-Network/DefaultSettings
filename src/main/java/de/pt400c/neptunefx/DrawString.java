...
public class DrawString {
	...
	private static String bidiReorder(String par1Str)
    {
	...
	private static void renderStringAtPos(String p_78255_1_, boolean p_78255_2_) {
        for (int i = 0; i < p_78255_1_.length(); ++i)
        {
            ...
            else
            {
                ...
                float f = renderCharAtPos(j, c0, (boolean) getField(italicStyleFr, MC.fontRenderer));
                ...
                if ((boolean) getField(boldStyleFr, MC.fontRenderer))
                {
                    ...
                    renderCharAtPos(j, c0, (boolean) getField(italicStyleFr, MC.fontRenderer));
                    setField(posXFr, (float) getField(posXFr, MC.fontRenderer) - f1, MC.fontRenderer);
