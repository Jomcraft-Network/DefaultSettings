...
import de.pt400c.defaultsettings.core.DefaultSettingsClassTransformer;
...
public abstract class Segment {
	...
	private static final String posXFr = DefaultSettingsClassTransformer.devEnv ? "posX" : "j";
	private static final String posYFr = DefaultSettingsClassTransformer.devEnv ? "posY" : "k";
	private static final String redFr = DefaultSettingsClassTransformer.devEnv ? "red" : "n";
	private static final String greenFr = DefaultSettingsClassTransformer.devEnv ? "green" : "p";
	private static final String blueFr = DefaultSettingsClassTransformer.devEnv ? "blue" : "o";
	private static final String alphaFr = DefaultSettingsClassTransformer.devEnv ? "alpha" : "q";
	private static final String randomStyleFr = DefaultSettingsClassTransformer.devEnv ? "randomStyle" : "s";
	private static final String boldStyleFr = DefaultSettingsClassTransformer.devEnv ? "boldStyle" : "t";
	private static final String italicStyleFr = DefaultSettingsClassTransformer.devEnv ? "italicStyle" : "u";
	private static final String underlineStyleFr = DefaultSettingsClassTransformer.devEnv ? "underlineStyle" : "v";
	private static final String strikethroughStyleFr = DefaultSettingsClassTransformer.devEnv ? "strikethroughStyle" : "w";
	private static final String textColorFr = DefaultSettingsClassTransformer.devEnv ? "textColor" : "r";
	private static final String colorCodeFr = DefaultSettingsClassTransformer.devEnv ? "colorCode" : "g";
	private static final String charWidthFr = DefaultSettingsClassTransformer.devEnv ? "charWidth" : "d";
	...
	public static void drawRect(double x1, double y1, double x2, double y2, Integer color, float alpha, boolean multiply)
    {
		double j1;
	...
	public static void drawRectRoundedUpper(float x1, float y1, float x2, float y2, int color, float alpha)
    {
        ...
        drawRect(x1 + 10, y1, x2 - 10, y1 + 10, null, 0, false);
        
        drawRect(x1, y1 + 10, x2, y2, null, 0, false);
	...
	public static void drawRectRoundedLower(float x1, float y1, float x2, float y2, int color, float alpha)
    {
        ...
        drawRect(x1, y1, x2, y2 - 10, null, 0, false);
        
        
        drawRect(x1 + 10, y2 - 10, x2 - 10, y2, null, 0, false);
	...
	public void resetStyles() {
		try {
			Method resetStyles = FontRenderer.class.getDeclaredMethod(DefaultSettingsClassTransformer.devEnv ? "resetStyles" : "b", new Class<?>[0]);
	...
	public int renderString(String p_78258_1_, double p_78258_2_, double p_78258_3_, int p_78258_4_, boolean p_78258_5_) {
        ...
        else
        {
            ...
            GL11.glColor4f((float) getField(redFr, MC.fontRenderer), (float) getField(blueFr, MC.fontRenderer), (float) getField(greenFr, MC.fontRenderer), (float) getField(alphaFr, MC.fontRenderer));
        ...
        for (int i = 0; i < p_78255_1_.length(); ++i)
        {
            ...
            if (c0 == 167 && i + 1 < p_78255_1_.length())
            {
                ...
                if (j < 16)
                {
                    ...
                    GL11.glColor4f((float)(k >> 16) / 255.0F, (float)(k >> 8 & 255) / 255.0F, (float)(k & 255) / 255.0F, (float) getField(alphaFr, MC.fontRenderer));
                }
                else if (j == 16)
                {
	...
	private static float renderUnicodeChar(char p_78278_2_, boolean p_78278_3_) {
		try {
			Method renderUnicodeChar = FontRenderer.class.getDeclaredMethod(DefaultSettingsClassTransformer.devEnv ? "renderUnicodeChar" : "a", char.class, boolean.class);
	...
	private static float renderDefaultChar(int p_78278_1_, boolean p_78278_3_) {
		...
		try {
			Method renderDefaultChar = FontRenderer.class.getDeclaredMethod(DefaultSettingsClassTransformer.devEnv ? "renderDefaultChar" : "a", int.class, boolean.class);
