...
public class GuiConfig extends DefaultSettingsGUI {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (!DefaultSettings.compatibilityMode) {
			...
			OpenGlHelper.glBindFramebuffer(GL_FRAMEBUFFER, this.framebufferMc.framebuffer);
		...
		if (!DefaultSettings.compatibilityMode) {
			...
			OpenGlHelper.glBindFramebuffer(GL_READ_FRAMEBUFFER, this.framebufferMc.framebuffer);
			OpenGlHelper.glBindFramebuffer(GL_DRAW_FRAMEBUFFER, this.framebufferMc.interFramebuffer);
	...
	public static class HeaderPart extends BakedSegment {
			...
			public void render(int mouseX, int mouseY, float partialTicks) {
				...
				if(!compiled) {
			        ...
			        GlStateManager.color(40F / 255F, 40F / 255F, 40F / 255F, 1);
					
					NEX.drawCircle(72 - 25F / 2F, 25F / 2F, 25F / 2F, 270, 50);

					GlStateManager.color(120F / 255F, 120F / 255F, 120F / 255F, 1);
